...
### OUTPUT
# vector indicating which instances are noisy in the response variable, 0 means not noise in the instance and 1 means noise

def RegENN02(data, response, k=9, alpha=5, algor='auto', n_jobs=1):
